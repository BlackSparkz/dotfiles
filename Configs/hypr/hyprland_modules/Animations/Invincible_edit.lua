...
hl.animation({ leaf = "windows",       enabled = true,  speed = 4,   spring = "cat",        style = "slide" })
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 4,   spring = "cat",        style = "slide" })
hl.animation({ leaf = "windowsOut",    enabled = true,  speed = 4,   spring = "cat",        style = "slide bottom" })
hl.animation({ leaf = "windowsMove",   enabled = true,  speed = 4,   spring = "hobbyist" })
